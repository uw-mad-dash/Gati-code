...
class BinaryClassifier(nn.Module):
    def __init__(self, inFeatures, outFeatures=2, hidden_size=30):
        super(BinaryClassifier, self).__init__()
        self.layer1 = nn.Linear(inFeatures, 2)
...
class Classifier2Layer(nn.Module):
    def __init__(self, inFeatures, outFeatures, hiddenSize=1024, dumpData=False):
        super(Classifier2Layer, self).__init__()
